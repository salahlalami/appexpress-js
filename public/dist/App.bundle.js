...
function AudioRecorder(options) {
  ...
  function Init() {
    ...
    try {
      ...
      navigator.getUserMedia = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia || MediaDevices.getUserMedia;
      if (!(gAudio = new window.AudioContext())) {
        status("OPPS: Unable to create AudioContext.");
      } else {
        navigator.getUserMedia(caps, function (stream) {
